...
// https://en.wikipedia.org/wiki/List_of_LGBT_community_centers
// osm: community_centre:for=lgbtq
// osm: lgbtq=primary
// https://wiki.openstreetmap.org/wiki/Key:lgbtq
const places = [
	{
		"name": "Los Angeles LGBT Center", // McDonald/Wright Building
		"lat": 34.1005628,
		"lng": -118.3327632,
		"address": "1625 N. Schrader Blvd., Los Angeles, CA 90028-6213",
		"min_age": -1,
		"max_age": -1,
		"website": "https://lalgbtcenter.org/",
		"links": "https://lalgbtcenter.org/ https://www.youtube.com/user/LAGayCenter https://twitter.com/LALGBTCenter https://www.instagram.com/lalgbtcenter/ https://www.facebook.com/LAlgbtcenter/",
		"this_is_a_place_for": [],
		"tags": []
		// https://www.openstreetmap.org/node/6261884983
		// https://www.wikidata.org/wiki/Q6682231
	},
	{
		"name": "Anyway",
		"lat": 50.9419,
...
// const places_min_age = new Set(places.map(place=>place.min_age))
// const places_max_age = new Set(places.map(place=>place.max_age))

// console.log('places_min_age', places_min_age)
// console.log('places_max_age', places_max_age)

// const items = [...places.reduce((a,place)=>{
// 	for (const item of place.tags) {
// 		a.add(item)
// 	}
// 	return a
// },new Set())]
// console.log('items', JSON.stringify(items).replace(/"/g,"'"))
